      ...
      >
        ...
        <div>
          ...
          <span className="hidden md:block">
            ...
            <AnimatedConnectionCircle
              src="/about/project_workspace.svg"
              top="4%"
              left="32%"
              delay={0.2}
              sizeClass="w-14 h-14"
